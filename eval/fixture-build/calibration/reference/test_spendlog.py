...
def test_search_treats_the_visitor_term_as_data(conn):
    importer.import_budget_csv(conn, EXPORT)
    quoted = "q=" + chr(39) + " OR 1=1 --"
    assert handlers.search_expenses(conn, quoted) == []
