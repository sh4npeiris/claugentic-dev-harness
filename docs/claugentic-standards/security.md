...
- **Auditor checks —** `[J]` an erasure request reaches this data **everywhere it lands** — replicas, backups, logs, indexes, third parties · `[J]` a hard-delete path exists for regulated data, not only soft-delete.
