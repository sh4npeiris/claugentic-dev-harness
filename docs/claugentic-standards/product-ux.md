...
- **Good looks like —** **WCAG 2.2 Level AA.** Contrast **≥4.5:1** normal text / **≥3:1** large text and UI components. The 2.2-specific criteria, which are the ones most often missed: **focus not obscured** (2.4.11) · **focus appearance** (2.4.13) · **dragging alternative** (2.5.7) · **target size ≥ 24×24 CSS px** (2.5.8) · **consistent help** (3.2.6) · **redundant entry** avoided (3.3.7) · **accessible authentication** (3.3.8).
