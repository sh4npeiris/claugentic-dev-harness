...
No product spec yet for the harness itself — run `/claugentic-dev-harness:product` spec mode to define one, then gap mode regenerates this fence. (An adopter's product backlog is generated here when they run gap mode against their `docs/PRODUCT_SPEC.md`.)
