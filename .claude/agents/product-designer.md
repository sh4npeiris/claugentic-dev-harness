...
description: Product/UX discovery + design lens (Stage 1, user-facing work). Surfaces the user, the job-to-be-done, the flows and their empty/loading/error states, and what "good" feels like — before the technical plan. Applies the product-ux standard; persists durable answers to docs/claugentic-PRODUCT.md. Use when a change touches a user-facing surface.
