...
- Add/extend tests for the change. Then, before declaring done, run the project's full test suite (incl. any regression/snapshot tests), `python scripts/check_architecture_tree.py`, and the project's lint / type-check / security gates — all green.
