...
- **Bound the loop with a conditional PASS + a named residual.** When what remains is a single addition you have already validated, say so — *"PASS conditional on R<N>-a; no further gate round"* — and name the exact edit and where it goes. (Used at 0041 S2 (R2-a) and S3 (R3-a); both landed in the next commit without a re-gate.)
