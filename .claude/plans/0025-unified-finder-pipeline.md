...
- **Placement of the architect-pass / Architecture-fit template section:** land it once (shared with `0026`); it applies to ALL plans immediately (incl. ad-hoc builds, and this very plan) — sequence so it isn't authored twice.
