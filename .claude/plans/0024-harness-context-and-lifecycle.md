...
- **Resumable from:** S1 ✅ landed. **Next: S3** (INVARIANTS budget + advisor off-switch & nuanced audience-split) — then S4a, S4b, S5. (Stage-3 review folded; see Decomposition + Review.)
