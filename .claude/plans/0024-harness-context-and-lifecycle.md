...
- **Resumable from:** S1 ✅ + S3 ✅ landed. **Next: S4a** (shared-adopter pre-commit init-wiring + `--hook*` mode retirement) — then S4b, S5. (Stage-3 review folded; see Decomposition + Review.)
